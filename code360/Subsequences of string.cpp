...
#include <bits/stdc++.h> 
void solve(string str,string ouput , int index , vector<string>& ans){
	// base case
	if(index >= str.size()){
		if(ouput.length() > 0) ans.push_back(ouput);
		return;
	}

	// Exclude
	solve(str,ouput,index+1,ans);
